...
void ADC_GetValue(void)
{
	...
	for(i=0;i<3;i++)
	{
		ADC_Array_Original[0][i] = adc_once(ADC_P00, ADC_8BIT);		//左一路电感
		ADC_Array_Original[1][i] = adc_once(ADC_P05, ADC_8BIT);		//左二路电感

		ADC_Array_Original[2][i] = adc_once(ADC_P10, ADC_8BIT);		//中间横电感
